...
def encode_onehot(labels, num_classes=10):   # changed this when working with a different dataset  
    """
    one-hot labels
...
class Onehot(object):
    def __call__(self, sample, num_classes=10): # changed this when working with a different dataset
